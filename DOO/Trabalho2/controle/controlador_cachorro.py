...
from persistencia.cachorro_dao import CachorroDAO
...
class ControladorCachorro:
    ...
    @property
    def cachorros(self):
        return self.__cachorro_dao.pega_todos()
    ...
    def pega_cachorro_por_chip(self, numero_chip: int):
        for cachorro in self.__cachorro_dao.pega_todos():
    ...
    def cadastrar_cachorro(self):
        ...
        if dados_cachorro["opcao"] == 'Confirmar':
        ...
        try:
            if cachorro is None:
                ...
                self.__cachorro_dao.adiciona(cachorro)
        ...
        try:
            if cachorro is not None:
                ...
                novos_dados_cachorro = self.__tela_cachorro.\
                    pega_dados_cachorro({"numero_chip": cachorro.numero_chip, "nome": cachorro.nome, "raca": cachorro.raca, "tamanho": cachorro.tamanho})
    ...
    def listar_cachorro(self):
        cachorros = []
        for cachorro in self.__cachorro_dao.pega_todos():
            cachorros.append({"numero_chip": cachorro.numero_chip,
                                                  "nome": cachorro.nome,
                                                  "raca": cachorro.raca,
                                                  "tamanho": cachorro.tamanho})
        self.__tela_cachorro.mostra_cachorro(cachorros)
    ...
    def remover_cachorro(self):
        ...
        try:
            if cachorro is not None:
                self.checa_cachorro(cachorro)
                self.__cachorro_dao.remove(numero_chip)
